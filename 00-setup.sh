...
:'
This should really be done manually. You just need to get the input data where it needs to go. In this case, the only input is the genome assembly.
The "reference" needs to be located at data/assembly/asm.fa[.gz]. This can be a symbolic link. This is what I did:
